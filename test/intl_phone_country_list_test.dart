  ...
  group('Countries are loaded test', () {
    test('Json is correctly loaded in to memory', () async {
      ...
      Countries.countryList.forEach((Map<String, dynamic> data) {
        ...
        expect(country.nameTranslations!.length, equals(expectedTranslations.length));
        expectedTranslations.forEach((language) => expect(country.nameTranslations!.containsKey(language), true));
      });
    });
  });
}
