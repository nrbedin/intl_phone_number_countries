...
import 'package:intl_phone_number_countries/intl_phone_number_countries_test.dart';
...
main() {
  group('International Phone Number Input', () {
    ...
    test('Scroll to view and Select Country', () async {
      await driver.scroll(find.byType('SingleChildScrollView'), 0, -18500, Duration(milliseconds: 300));
